...
export async function installArtifacts(session: Session, artifacts: Array<Artifact>, options?: { force?: boolean, allLanguages?: boolean, language?: string, artifactTag?: string }): Promise<[boolean, Map<Artifact, boolean>]> {
